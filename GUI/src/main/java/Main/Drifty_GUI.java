...
import GUI_Support.ManageFolders;
...
import static Main.GUI_Logic.getDirectory;
import static javafx.scene.layout.AnchorPane.*;

public class Drifty_GUI extends Application {
    private static Drifty_GUI INSTANCE;
    ...
    public void start(Stage primaryStage) {
        primaryStage = Utility.getStage("Drifty GUI", true);
    ...
    private Menu getMenuItemsOfMenu() {
        ...
        website.setOnAction(e -> openWebsite(Constants.PROJECT_WEBSITE));
        MenuItem exit = new MenuItem("Exit");
        exit.setOnAction(e -> {
            M.msgLogInfo(Constants.GUI_APPLICATION_TERMINATED);
            System.exit(0);
        });
