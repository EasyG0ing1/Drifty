...
public class Drifty_CLI {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (!batchDownloading) {
                ...
                System.out.print("Enter the download directory (\".\" for default or \"L\" for " + AppSettings.get.lastDownloadFolder() + ") : ");
    ...
    public static void help() {
        ...
        System.out.println("\tProject Website - " + PROJECT_WEBSITE);
    }
